...
(uint32_t) &FlexLin1_Uart_Isr, /* Vector # 380 LINFlex_RXI LINFlex_1 */
...
(uint32_t) &FlexCAN0_Isr, /* Vector # 524 FLEXCAN_BUF_08_11 FlexCAN_0 */
...
(uint32_t) &FlexCAN1_Isr, /* Vector # 537 FLEXCAN_BUF_08_11 FlexCAN_1 */
